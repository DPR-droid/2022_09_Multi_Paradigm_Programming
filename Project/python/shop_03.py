...
class TheShop:
    ...
    def print_shop(s):
        ...
        for item in s.stock:
            TheShop.print_product(item.product)
...
def main():
    ...
    s = TheShop.create_and_stock_shop()
    ...
    while True: 
        ...
        if (choice == "1"):
            ...
            TheShop.print_shop(s)
            # break
            
        # 
        elif (choice == "2"):
            c = TheCustomer.read_customer("../customer.csv")
            TheCustomer.print_customer(c, s)
